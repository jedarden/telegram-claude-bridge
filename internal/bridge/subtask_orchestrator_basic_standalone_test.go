// Package bridge provides a standalone test for splitParallelPrompts.
// This file can be compiled and tested independently.
package bridge
...
// copy of splitParallelPrompts for standalone testing
...
func TestSplitParallelPrompts_BasicSplits_Standalone(t *testing.T) {
	tests := []struct {
		name         string
		input        string
		wantLen      int
...
func TestSplitParallelPrompts_SplitCountVerification_Standalone(t *testing.T) {
	tests := []struct {
		name        string
		input       string
		wantCount   int
...
func TestSplitParallelPrompts_DelimiterHandling_Standalone(t *testing.T) {
	tests := []struct {
		name         string
		input        string
		wantLen      int
...
func TestSplitParallelPrompts_WhitespaceContentHandling_Standalone(t *testing.T) {
	tests := []struct {
		name        string
		input       string
		wantLen     int
...
func TestSplitParallelPrompts_DelimiterRemoval_Standalone(t *testing.T) {
	tests := []struct {
		name        string
		input       string
		wantLen     int
